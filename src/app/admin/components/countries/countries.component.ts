...
export class CountriesComponent implements OnInit {
  ...
  editIndex: number | any = 0;
  deleteIndex: number | any = 0;
  ...
  //Autofocus TextBoxes
  @ViewChild("defaultTextBox_New") defaultTextBox_New: ElementRef | any = 0;
  @ViewChild("defaultTextBox_Edit") defaultTextBox_Edit: ElementRef | any = 0;
